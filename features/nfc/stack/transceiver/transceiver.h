...
//typedef void (*append_read_data_fn_t)(nfc_transceiver_t* pTransceiver, bool append);
...
/*
static inline nfc_err_t transceiver_get_result(nfc_transceiver_t* pTransceiver)
{
  return pTransceiver->result;
}
*/
